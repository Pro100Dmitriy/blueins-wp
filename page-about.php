...
?>
        ...
        <div class="container abount-no-padding">
            <section class="first-message">
                <div class="small-container">
                    <h2 class="h2-style"><?php echo get_field('about-company-title'); ?></h2>
                    <div class="first-message__table">
                        <?php if( get_field('about-company-description') ) : ?>
                            <div class="first-message__table__first-column regular-fiveteen" data-aos="fade-up"  data-aos-delay="0">
                                <?php echo get_field('about-company-description'); ?>
                            </div>
                        <?php endif;?>
                    </div>
                </div>
        ...
        <section class="qualitu-comf">
            <div class="container">
                <div class="qualitu-comf__flex">
                <div class="qualitu-comf__flex__img-cover" data-aos="fade-up"  data-aos-delay="0">
                    <img class="qualitu-comf__flex__img-cover__img" src="<?php echo get_field('about-company-section-img-2'); ?>" alt="IMG">
                </div>
                <div class="qualitu-comf__flex__text">
                    <?php if( get_field('about-company-section-title-2') ) : ?>
                    <h2 class="h2-style"><?php echo get_field('about-company-section-title-2'); ?></h2>
                    <?php endif;?>
                    <?php if( get_field('about-company-section-description-2') ) : ?>
                    <div class="regular-fiveteen paragraph" data-aos="fade-up"  data-aos-delay="100">
                        <?php echo get_field('about-company-section-description-2'); ?>
                    </div>
                    <?php endif;?>
                </div>
                </div>
        ...
        <section class="about about-page">
            <div class="container">
                ...
                <h2 class="section-text__title h2-style"><?php echo get_field('about-company-section-title-3'); ?></h2>
                </div>
                <div class="about__content" data-aos="fade-up"  data-aos-delay="0">
                    <div class="about__content__img-cover">
                        <img class="about__content__img-cover__img" src="<?php echo get_field('about-company-section-img-3'); ?>" alt="Bluins">
                    </div>
                    <?php $count = 0;?>
                    <?php
                        $qualityCompany = explode( ' | ', get_field('about-company-section-description-3') );
        ...
        <section class="feedback about-feedback">
            <div class="container">
                <div class="section-title">
                    <h2 class="section-text__title h2-style">Отзывы наших клиентов</h2>
                </div>
        ...
        <section class="question-form about-question-form">
            <div class="small-container">
                <div class="section-title">
                    <h2 class="section-text__title h2-style">Хочешь оставить отзыв?</h2>
                    <p class="seciton-text__description regular-fiveteen">Если ты из тех кто нам нужен, то напиши нам и менеджер обязательно с тобой свяжется.</p>
                </div>
                <!-- <div class="question-form__content">
                    ...
                    <div class="question-form__content" data-aos="fade-up"  data-aos-delay="0"> 
                        <?php echo do_shortcode('[contact-form-7 id="697" title="Оставить отзыв"]'); ?>
                    </div>
                </div>
        </section>
